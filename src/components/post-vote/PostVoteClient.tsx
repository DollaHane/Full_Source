...
const PostVoteClient = ({
  ...
  return (
    <div className='flex justify-between sm:w-28 pb-4 sm:pb-0'>
      {/* upvote */}
      <Button
        ...
        <ArrowBigUp
          className={cn('h-4 w-4 text-capecod-500 hover:text-green-500', {
            'text-green-500 fill-green-500': currentVote === 'UP',
          })}
        />
      </Button>

      {/* score */}
      <p className='text-center w-5 py-2 font-medium text-sm text-capecod-500'>
        {votesAmt}
      </p>
